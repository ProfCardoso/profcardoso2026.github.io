...
<html>
    ...
    <body>
        <h1>Un titre</h1>
        <p id="roger">Un paragraphe inutile</p>
        <button onclick="enRouge()">En rouge</button>
        <button onclick="enVert()">En vert</button>
    </body>
</html>
...
function enRouge() {
    document.getElementById("roger").classList.add("rouge")
    document.getElementById("roger").classList.remove("vert")
}

function enVert() {
    document.getElementById("roger").classList.remove("rouge")
    document.getElementById("roger").classList.add("vert")
}
```

## Évènements

Pour le moment nous n’avons vu qu’un seul évènement, l’évènement « **onclick** » qui se déclenche lorsqu’on clique avec la souris. Il en existe de nombreux autres (voir les évènements sur W3schools) et on peut les utiliser sur d’autres éléments que les boutons. Voici des évènements de la souris qui peuvent être utiles :
...
<html>
    ...
    <body>
        <p id="parag1" onmouseover="parag1vert()" onmouseout="parag1rouge()" class="rouge">Un paragraphe inutile</p>
        <p id="parag2" onmouseover="parag2vert()" onmouseout="parag2rouge()" class="rouge">Un paragraphe inutile</p>
        <p id="parag3" onmouseover="parag3vert()" onmouseout="parag3rouge()" class="rouge">Un paragraphe inutile</p>
        <p id="parag4" onmouseover="parag4vert()" onmouseout="parag4rouge()" class="rouge">Un paragraphe inutile</p>
        <p id="parag5" onmouseover="parag5vert()" onmouseout="parag5rouge()" class="rouge">Un paragraphe inutile</p>
    </body>
</html>
CSS :
...
function parag1vert() {
    document.getElementById("parag1").classList.add("vert")
    document.getElementById("parag1").classList.remove("rouge")
}

function parag1rouge() {
    document.getElementById("parag1").classList.add("rouge")
    document.getElementById("parag1").classList.remove("vert")
}

function parag2vert() {
    document.getElementById("parag2").classList.add("vert")
    document.getElementById("parag2").classList.remove("rouge")
}

function parag2rouge() {
    document.getElementById("parag2").classList.add("rouge")
    document.getElementById("parag2").classList.remove("vert")
}

function parag3vert() {
    document.getElementById("parag3").classList.add("vert")
    document.getElementById("parag3").classList.remove("rouge")
}

function parag3rouge() {
    document.getElementById("parag3").classList.add("rouge")
    document.getElementById("parag3").classList.remove("vert")
}

function parag4vert() {
    document.getElementById("parag4").classList.add("vert")
    document.getElementById("parag4").classList.remove("rouge")
}

function parag4rouge() {
    document.getElementById("parag4").classList.add("rouge")
    document.getElementById("parag4").classList.remove("vert")
}
function parag5vert() {
    document.getElementById("parag5").classList.add("vert")
    document.getElementById("parag5").classList.remove("rouge")
}

function parag5rouge() {
    document.getElementById("parag5").classList.add("rouge")
    document.getElementById("parag5").classList.remove("vert")
}

La version avec 2 fonctions
HTML :
...
<html>
    ...
    <body>
        <p onmouseover="paragVert(this)" onmouseout="paragRouge(this)" class="rouge">Un paragraphe inutile</p>
        <p onmouseover="paragVert(this)" onmouseout="paragRouge(this)" class="rouge">Un paragraphe inutile</p>
        <p onmouseover="paragVert(this)" onmouseout="paragRouge(this)" class="rouge">Un paragraphe inutile</p>
        <p onmouseover="paragVert(this)" onmouseout="paragRouge(this)" class="rouge">Un paragraphe inutile</p>
        <p onmouseover="paragVert(this)" onmouseout="paragRouge(this)" class="rouge">Un paragraphe inutile</p>
...
function paragVert(parag) {
    parag.classList.add("vert")
    parag.classList.remove("rouge")
}

function paragRouge(parag) {
    parag.classList.add("rouge")
    parag.classList.remove("vert")
}
```
