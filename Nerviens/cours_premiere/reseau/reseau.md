...
<strong>Qu'est-ce qu'un réseau ?</strong><br>
...
<div style="display: flex; flex-direction:column;  border: 1px solid #ccc; text-align: center; border-radius: 8px;">
  <img src="../../images/reseaux_topologies.png" alt="Python" width="800" />
  <span style="font-style: italic; color: gray;">Quelques topologies de réseaux</span>
</div>

## Équipements d'un réseau

<div style="display: flex; flex-direction:column;  border: 1px solid #ccc; text-align: center; border-radius: 8px;">
  <img src="../../images/equipements.png" alt="Python" width="800" />
  <span style="font-style: italic; color: gray;">Quelques équipements d'un réseau</span>
</div>
...
<div style="display: flex; flex-direction:column;  text-align: center; ">
  <img style="margin: auto;" src="../../images/wan_man_lan.png" alt="Python" width="800" />
</div>

<br>

<div style="border:2px solid #af4c4cff; padding:10px; border-radius:8px">
<strong>Réseau local, ou LAN (Local Area Network)</strong><br>
...
<div style="display: flex; flex-direction:column;  text-align: center; ">
  <img style="margin: auto;" src="../../images/reseau_sans_legende.png" alt="Python" width="800" />
</div>
